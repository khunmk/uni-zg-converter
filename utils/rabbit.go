/**
 * Please note: this code are credit to : https://github.com/saturngod
 * and his works ==> https://github.com/Rabbit-Converter/Rabbit
 *
 *
 * What i modify is just add an error handling for my later use.
 */
...
func Uni2zg(str string) (string, error) {
	unizgRule := `[
    {
        "from": "\u1004\u103a\u1039",
        "to": "\u1064"
...
func Zg2uni(str string) (string, error) {
	zguniRule := `[
    {
        "from" : "([\u102D\u102E\u103D\u102F\u1037\u1095])\\1+",
        "to" : "$1"
...
func replaceRule(ruleJson string, output string) (string, error) {
	...
	for i := range rules {
		...
		res, err := re.Replace(output, rules[i].To, 0, -1)
		if err != nil {
			return output, err
		}
		output = res
